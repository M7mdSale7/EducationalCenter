...
namespace EducationalCenter
{
    public partial class UserControl1T : UserControl
    {
        ...
        public UserControl1T()
        {
            InitializeComponent();
            random = new Random();
            string name = Controller.Instance.getTeacherName(Form0.Instance.username,"");
        ...
        private void buttonViewSchedule_Click(object sender, EventArgs e)
        {
            ...
            OpenChildForm(new UserControl2T_A());
        ...
        private void buttonGradesReport_Click(object sender, EventArgs e)
        {
            Reset();
            ActivateButton(sender);
            OpenChildForm(new UserControl2T_C());
            labelTitle.Text = "Schedule";
        }
        ...
        private void buttonExams_Click(object sender, EventArgs e)
        {
            Reset();
            ActivateButton(sender);
            OpenChildForm(new UserControl2T_D());
            labelTitle.Text = "Schedule";
        }
        ...
        private void buttonStudents_Click(object sender, EventArgs e)
        {
            Reset();
            ActivateButton(sender);
            OpenChildForm(new UserControl2T_B());
            labelTitle.Text = "Schedule";
        }
        ...
        private void buttonTA_Click(object sender, EventArgs e)
        {
            Reset();
            ActivateButton(sender);
            OpenChildForm(new UserControl2T_E());
            labelTitle.Text = "Schedule";
        }
